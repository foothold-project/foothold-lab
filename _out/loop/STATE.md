...
**이 내용이 된 때** 2026-09-23 19:47 · 감시 스크립트 (평가를 거는 판)
...
막힌 것   [0-b] 를 시드 43 으로는 완주할 수 없다. 결정론적으로 죽는다. 다른 시드로 갈지 팀장이 정한다. [0-a] v2b-r 은 완주했으므로 평가할 수 있다
다음      v2b-s2 가 끝나면 두 판을 «cuda:1» 에서 평가한다 (v2b 기준선과 같은 장치)
          (막는 것: v2b-s2 종료)
```
