...
**이 내용이 된 때** 2026-09-23 18:06 · 감시 스크립트 (평가를 거는 판)
...
```
단계      [0] 기준 재기 · 학습 중 (v2b-s2) · v2b-r 완료
          두 판 병렬. 부모 v2a/v2b 도 5 초 차이로 같이 돌았으므로 조건이 같다
도는 것   v2b-s2  GPU cuda:1 (부모와 같음)  PID 76292  시작 2026-09-23T17:08:47+09:00
끝난 것   v2b-r(완료)  v2b-s(죽음)
막힌 것   없음
