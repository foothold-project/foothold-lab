...
| 판 | 언제 | 무엇이 바뀌었나 | 근거 |
|---|---|---|---|
| v1.0 | 2026-09-11 | 처음 씀. 59열을 구현했고 장애물 묶음만 v1.1 로 남겨 두었다. 초안은 세션이 팀장 지시로 썼고 팀장 명의로 낸다. 머리의 시각 `18:27` 은 **이 문서의 첫 커밋 시각**이다 (`21748a5`). 세션이 쓰고 같은 자리에서 커밋한 문서라 그렇게 적는다 | git 이력 |
