...
- 45차원은 우리와 **관측 체급이 다른 참고선**이다. 증류로 체급을 맞추는 계획은 8/19 에 폐기됐다

## 판 이력

| 판 | 언제 | 무엇이 바뀌었나 | 근거 |
|---|---|---|---|
| **v1.1** | 2026-08-28 | 「Student 비교 상대」 표현을 걷어냈다. 증류를 안 하므로 45차원 정책은 참고선이다. 깨져 있던 `FLOW §3` 참조도 고쳤다 | `DECISIONS` 08-19 |
