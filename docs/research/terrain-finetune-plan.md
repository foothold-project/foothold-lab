...
| `rails` | **맹라현** | 0.5 m/s · 50판: 2% (1/50) / **36%** / 0.93 ± 0.32 m<br>**1.0 m/s · 100판: 4% / 85% / 2.64 m** (09-03 재측정) | ~~낙상 우세 (평균 2.1초) · 가장 빨리 넘어진다~~<br>-> **전진불능형** (09-03 재분류 · 아래 상자) | ~~관측 · 발 배치 보상~~<br>-> **보상 · 명령 커리큘럼** |
...
>
> 위 배정의 근거는 **0.5 m/s · 50판** 위에 서 있었다. 같은 정책을 **1.0 m/s · 100판 · seed 42** 로 다시 돌리자 `rails` 만 성질이 바뀌었다.
>
> | 항목 | 0.5 m/s · 50판 | **1.0 m/s · 100판** |
> |---|---|---|
> | 생존율 | 36% | **85%** |
> | 전진 평균 | 0.93 m | **2.64 m** |
...
> | 종합 통과 | 2% | 4% |
>
> **속도를 올리니 안 넘어지고 앞으로 간다.** 100판 중 85판이 시간초과로 끝났고 67판이 2 m 를 넘겼다. 넘어져서 지는 것이 아니라 못 가서 진다.
>
> | 실패 모드 | 처방 |
> |---|---|
> | 낙상형 | 관측 · 발 배치 보상 |
