...
직진성은 **어느 지점에서 재는지에 따라 값이 달라진다.** 같은 100판에서 10 m 통과선 지점의 좌우 이탈은 평균 0.086 m (각도 0.49도)이고, 20초 종료 시점(평균 전진 19.08 m)의 이탈은 평균 2.143 m 다. 위 표의 33/100 은 **통과선 지점 기준**이다.
