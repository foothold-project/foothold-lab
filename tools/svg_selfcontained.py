...
되고, 검색 색인에 그림 안 좌표와 글자가 들어가 검색이 흐려지고, 빌드가 10분을
...
어둡게 해 둔 사람은 그림이 밝게 보인다. 검정으로 안 보이는 것보다는 낫고,
...
LIGHT = {
    ...
    # 2026-09-14. 손그림 그림 4장이 쓰던 색. 값은 사이트 CSS 에서 가져왔다.
