...
/* 2026-09-14. 아직 다크 색을 못 정한 손그림 도해는 밝은 판 위에 올린다.
...
<script>(function(){
  ...
  function figs(t){
    /* 2026-09-14. <img> 안의 도해는 «격리된 문서» 라 이 페이지의 data-theme 이
       안 닿는다. 도해 스스로는 OS 설정(prefers-color-scheme)만 볼 수 있어서,
       OS 가 라이트인 사람이 사이트를 다크로 바꾸면 도해만 라이트로 남았다.
