...
| | `sim/eval/eval_generalization.py` | `sim/eval/runpod/play_eval.py` (이 폴더) |
|---|---|---|
| 어디서 도나 | Isaac Lab 깔린 워크스테이션 | RunPod 팟 |
| 지형 정의 | `generalization_env_cfg.py` | `terrain_cfg.py` |
| 이력 관리 | `PROVENANCE.md` (2026-08-22 스냅샷 대조) | 없음. 이 README 가 전부 |
